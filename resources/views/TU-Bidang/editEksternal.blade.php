                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div style="overflow-x: auto;">
                                <form action="{{ route('tu-bidang.updateEksternal', $dataAgendaEksternal->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <table style="width: 100%; border-collapse: separate; border-spacing: 15px;">
                                        <tr>
                                            ...
                                            <td> : </td>
                                            <td><input type="text" name="no_surat" class="form-control" value="{{ $dataAgendaEksternal->no_surat }}" required disabled></td>
                                        </tr>
                                        <tr>
                                            <td><label for="tanggal_surat">Tanggal Surat</label></td>
                                            <td> : </td>
                                            <td><input type="date" name="tanggal_surat" class="form-control" value="{{ $dataAgendaEksternal->tanggal_surat }}" required disabled></td>
                                        </tr>
                                        <tr>
                                            <td><label for="pengundang">Pengundang</label></td>
                                            <td> : </td>
                                            <td><input type="text" name="pengundang" class="form-control" value="{{ $dataAgendaEksternal->pengundang}}" required disabled></td>
                                        </tr>
                                        <tr>
                                            <td><label for="tempat">Tempat</label></td>
                                            <td> : </td>
                                            <td><input type="text" name="tempat" class="form-control" value="{{ $dataAgendaEksternal->tempat }}" required disabled></td>
                                        </tr>
                                        <tr>
                                            <td><label for="tanggal_acara">Tanggal Acara</label></td>
                                            <td> : </td>
                                            <td><input type="date" name="tanggal_acara" class="form-control" value="{{ $dataAgendaEksternal->tanggal }}" required disabled></td>
                                        </tr>
                                        <tr>
                                            <td><label for="acara">Acara</label></td>
                                            <td> : </td>
                                            <td><input type="text" name="acara" class="form-control" value="{{ $dataAgendaEksternal->acara }}" required disabled></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> : </td>
                                            <td><input type="text" name="nama_pendamping" class="form-control" value="{{ $dataAgendaEksternal->nama_pendamping }}" required></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> : </td>
                                            <td><input type="time" name="waktu" class="form-control" value="{{ $dataAgendaEksternal->waktu }}" required disabled></td>
                                        </tr>
                                        <tr>
                                            <td><label for="catatan">Catatan</label></td>
                                            <td> : </td>
                                            <td>
                                                <textarea name="catatan" rows="4" class="form-control" required placeholder="Masukkan Catatan">{{ old('catatan', $dataAgendaEksternal->catatan) }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
