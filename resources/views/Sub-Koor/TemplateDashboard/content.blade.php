                            ...
                            <div class="direct-chat-contacts">
                                <ul class="contacts-list">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="{{asset("AdminLTE-4.0.0-beta3")}}/dist/assets/img/user7-128x128.jpg"
                                                alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    Sarah Doe
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="{{asset("AdminLTE-4.0.0-beta3")}}/dist/assets/img/user5-128x128.jpg"
                                                alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    Nora S. Vans
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="{{asset("AdminLTE-4.0.0-beta3")}}/dist/assets/img/user6-128x128.jpg"
                                                alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    John K.
