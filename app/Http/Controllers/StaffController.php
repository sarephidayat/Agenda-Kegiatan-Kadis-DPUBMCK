...
class StaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Staff.dashboard', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));

    }

    public function tambah()
    {
        return view('Staff.tambah', $this->getDropdownData());
    }
    ...
    public function edit($id)
    {
        ...
        return view('Staff.edit', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));
    ...
    public function agendaEksternal()
    {
        ...
        return view('Staff.agendaEksternal', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));
    ...
    public function agendaInternal()
    {
        ...
        return view('Staff.agendaInternal', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));
