...
class StaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Staff/dashboard', compact('dataAgendaEksternal', 'dataAgendaInternal', 'jabatan', 'bidang', 'instruksi', ));
    }

    public function tambahAgendaInternal()
    {
        return view('Staff/tambahAgendaInternal', $this->getDropdownDataInternal());
    }

    public function tambahAgendaEksternal()
    {
        return view('Staff/tambahAgendaEksternal', $this->getDropdownDataEksternal());
    }
    ...
    public function editEksternal($id)
    {
        ...
        return view('Staff/editEksternal', compact('dataAgendaEksternal', 'jabatan', 'bidang', 'instruksi'));
    ...
    public function editInternal($id)
    {
        ...
        return view('Staff/editInternal', compact('dataAgendaInternal', 'bidang'));
    }
