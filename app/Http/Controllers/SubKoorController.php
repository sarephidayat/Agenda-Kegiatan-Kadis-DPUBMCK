...
class SubKoorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Sub-Koor.dashboard', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));

    }

    public function tambah()
    {
        return view('Sub-Koor.tambah', $this->getDropdownData());
    }
    ...
    public function edit($id)
    {
        ...
        return view('Sub-Koor.edit', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));
    ...
    public function agendaEksternal()
    {
        ...
        return view('Sub-Koor.agendaEksternal', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));
    ...
    public function agendaInternal()
    {
        ...
        return view('Sub-Koor.agendaInternal', compact('data', 'jabatan', 'bidang', 'instruksi', 'cakupan'));
